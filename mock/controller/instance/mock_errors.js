...
module.exports = app => {
  app.get('/xapi/error_files', function (req, res) {
    ...
    // const path1 = `/Users/hyj1991/git/monitor/xui/logs/xui/common-${Math.random().toString(16).slice(2, 8)}-error.log`;
    // const path2 = `/Users/hyj1991/git/monitor/xprofiler/logs/xprofiler/xprofiler-${Math.random().toString(16).slice(2, 8)}-error.log`;

    const path1 = `/Users/hyj1991/git/monitor/xui/logs/xui/common-error.log`;
    const path2 = `/Users/hyj1991/git/monitor/xprofiler/logs/xprofiler/xprofiler-error.log`;
