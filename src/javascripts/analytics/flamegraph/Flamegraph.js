...
const colorMap = (function () {
  ...
  function colorMap(paletteMap, colorTheme, hash, func) {
    if (Object.prototype.hasOwnProperty.call(paletteMap, func)) return paletteMap[func];
...
const contextify = (function () {
  ...
  function contextify(parsed, opts) {
    ...
    let xpad = 10;
    let xpad2 = opts.imagewidth * 0.92;
...
export default {
  mounted() {
    this.setContext();
    window.addEventListener("resize", this.setContext.bind(this));
  },
  ...
  computed: {
    ...
    enlarge() {
      return (this.showBigPic && "ZoomOut") || "ZoomIn";
    }
  },
